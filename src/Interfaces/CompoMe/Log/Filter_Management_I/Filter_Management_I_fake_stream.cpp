...
Filter_Management_I::get_fake_stream(CompoMe::Function_stream_send &fs,
  ...
  Filter_Management_I_fake_stream * a = new Filter_Management_I_fake_stream(fs, rs);
  std::tuple<Filter_Management_I_fake_stream*,
             CompoMe::Fake_stream*,
               Filter_Management_I*> rr(a, a, a);
  return rr;
}

Filter_Management_I_fake_stream::Filter_Management_I_fake_stream(CompoMe::Function_stream_send& out, CompoMe::Return_stream_recv& in):
