...
namespace Log{
  ...
  Filter::Filter():CompoMe::Component()/* PROVIDE */,input_log(this),filter_Manager(this)/* REQUIRE */,pass_log(NULL),refused_log(NULL)/* DATA */,filter(
/*WARNING NO DEFAULT VALUE FOR THIS TYPE*/){
  ...
  void Filter::stop() {
    ...
    Component::stop();
    // stop: sub_component
    C_INFO_TAG("STOP: Filter", "Component,Filter");return;
  }
  ...
  void Filter::status() {
    ...
    C_INFO_TAG("STATUS: Filter", "Component,Filter");return;
  }
