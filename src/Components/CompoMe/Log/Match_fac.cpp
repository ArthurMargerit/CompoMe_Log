...
CompoMe::Log::Match* Match_fac::build(const std::string& p_type, std::istream& p_stream, CompoMe::Serialization_context_import& p_ctx) {
...
std::shared_ptr<CompoMe::Log::Match> Match_fac::build_sp(const std::string& p_type, std::istream& p_stream) {
...
void Match_fac::init() {
    ...
    CompoMe::Serializable_fac::Build_fac_f  f= [](const std::string& str,std::istream& p_s, CompoMe::Serialization_context_import& l_ctx)
                                               {return dynamic_cast<CompoMe::Serializable_Item*>(Match_fac::get_inst().build(str, p_s, l_ctx)); };
    ...
    CompoMe::Serializable_fac::get_inst().subscribe("CompoMe::Log::Match", f, f_sp);
    
  }

void Match_fac::subscribe(const std::string& ss, Build_fac_f v,Build_fac_f_sp v_sp) {
