...
void To_CircularFile_Log_I_log::error(CompoMe::String mess,
...
void To_CircularFile_Log_I_log::warning(CompoMe::String mess,
                                        CompoMe::Log::Log_Info i) {
  this->get_c().get_output()
    << i.a_Emitted_on().a_sec() << ":" << i.a_Emitted_on().a_usec()
...
void To_CircularFile_Log_I_log::debug(CompoMe::String mess,
                                      CompoMe::Log::Log_Info i) {
  this->get_c().get_output()
    << i.a_Emitted_on().a_sec() << ":" << i.a_Emitted_on().a_usec()
...
void To_CircularFile_Log_I_log::info(CompoMe::String mess,
                                     CompoMe::Log::Log_Info i) {
...
void To_CircularFile_Log_I_log::log(CompoMe::Log::Kind_e k,
                                    CompoMe::String mess,
                                    CompoMe::Log::Log_Info i) {
  switch (k) {
