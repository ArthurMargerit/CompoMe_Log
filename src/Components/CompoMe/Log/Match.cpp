...
namespace Log{
  ...
  Match::Match():CompoMe::Component()/* PROVIDE */,input_log(this)/* REQUIRE */,match_log(NULL),unmatch_log(NULL)/* DATA */,regex(
/*WARNING NO DEFAULT VALUE FOR THIS TYPE*/){
  ...
  void Match::stop() {
    ...
    Component::stop();
    // stop: sub_component
    C_INFO_TAG("STOP: Match", "Component,Match");return;
  }
  ...
  void Match::status() {
    ...
    C_INFO_TAG("STATUS: Match", "Component,Match");return;
  }
